...
class WooApprovalPage extends StatefulWidget {
  const WooApprovalPage({super.key});

  @override
  State<WooApprovalPage> createState() => _WooApprovalPageState();
}

class _WooApprovalPageState extends State<WooApprovalPage> {
  DateTime? _startDate;
  DateTime? _endDate;
  ...
  void _fetchWoooHistory() {
    if (_startDate != null && _endDate != null) {
      context.read<GetWoooApprovalBloc>().add(
        FetchWoooApprovalDataEvent(fromDate: _startDate!, toDate: _endDate!),
      );
    }
  }
      ...
      body: PageContainer(
        child: Column(
          children: [
            ...
            /// Static List
            Expanded(
              child: BlocBuilder<GetWoooApprovalBloc, GetWoooApprovalState>(
                builder: (context, state) {
                  if (state is GetWoooApprovalLoading) {
